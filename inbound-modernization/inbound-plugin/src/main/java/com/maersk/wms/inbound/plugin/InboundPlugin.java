...
/**
 * Base interface for all inbound plugins.
 * Plugins provide client-specific customizations for inbound operations.
 */
public interface InboundPlugin {
     ...
     */
    default boolean isEnabled(InboundPluginContext context) {
        return true;
    }
}
